 ...
 */
public class CancelledRentalFragment extends Fragment implements ItemClickCallback {
    ...
    public CancelledRentalFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(loginResponse.getRoles().get(0).equals("ROLE_LESSOR")){
            ...
            rentalService.getAllOrdersByUserIdAndStatus(Long.parseLong(loginResponse.getId()),EStatus.CANCELLED.toString(),loginResponse.getToken(),lessorOrderResponseCallback());

        }else if(loginResponse.getRoles().get(0).equals("ROLE_LESSEE")){
            rentalService.getAllRentalsByUserIdAndStatus(Long.parseLong(loginResponse.getId()), EStatus.CANCELLED.toString(), loginResponse.getToken(),lesseeOrderResponseCallback());
